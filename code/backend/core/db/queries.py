...
GET_FILE_ID: str =  'SELECT "file_id" FROM {DATABASE_NAME}.{COLLECTION_NAME} WHERE "file_id" = \'{FIELD_VALUE}\';'

DELETE_RECORDS: str = 'DELETE FROM {DATABASE_NAME}.{COLLECTION_NAME} WHERE "created_at" < \'{CUTOFF_DATE}\';'

GET_SPECIAL_TEMPLATES: str = 'SELECT "type", "customers" FROM SPECIAL_PO_TEMPLATES'